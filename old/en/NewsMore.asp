				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr valign="top">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="40%" height="36" align="left"><div id="lbt"><%=daohang("title")%></td>
								<td align="right" style="padding-right:10px;"><div id="lat">Location：<a href="Index.asp">Home</a> > <a href="NewsMore.asp?id=<%=daohang("id")%>"><%=daohang("title")%></a></div></td>
							</tr>
						</table>  
						</td>
					</tr>
