				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr valign="top">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="130" height="36" align="center"><div id="lbt">Product</div></td>
								<td align="right" style="padding-right:10px;"><div id="lat">
					Location：<a href="Products.asp?BigClassID=<%=rs("BigClassID")%>"><%=bigClass("BigClassName")%></a> <%if rs("SmallClassID")=0 then %>
					<%else%>
