...
db="/shuju/w78#126@#@#%$#df67d8s678.mdb"		'记录数据库路径修改为你的数据库路径
dim conn,connstr 
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
  <tr>
    <td height="30" background="images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">SQL注入管理</div> </td>
  </tr>
  <tr>
...
n=listnum*nn
        ...
        <td bgcolor="#F1F5F8">攻击ＩＰ</td>
        <td bgcolor="#F1F5F8">当前状态</td>
        <td bgcolor="#F1F5F8">是否锁定</td>
        <td bgcolor="#F1F5F8">操作页面</td>
        <td bgcolor="#F1F5F8">操作时间</td>
        <td bgcolor="#F1F5F8">提交方式</td>
        <td bgcolor="#F1F5F8">提交参数</td>
        <td bgcolor="#F1F5F8">提交数据</td>
      </tr>
...
n=n+1%>
      <form action="?del=ok" method="post" name="check" id="check">
        <tr align="center" bgcolor="#FFFFFF" height="22">
          ...
          <td class="td"><%	if rs("Kill_ip")=true then 
...
loop%>
        <tr bgcolor="#FFFFFF">
          <%filename=URL%>
          <td colspan="9" align="right">共<%=Rs.recordcount%> 条记录&nbsp;&nbsp;<%=listnum%> 条记录/页&nbsp;&nbsp;共 <%=rs.pagecount%> 页
            <% if page=1 then %>
              <%else%>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
  <tr>
    <td height="30" background="images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">SQL防注入设置</div></td>
  </tr>
  <tr>
