	...
	<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:15px; background:#FFFFFF">
	  <tr>
		...
		<!--右-->
					...
					<tr valign="top">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<div id="lat">当前位置：<a href="Index.asp">首页</a> > <%if BigClassID="" then %>产品中心<%else%>
				...
				if rs.eof then
				response.Write "<div style=""padding:10px"">暂无图片！</div>"
				else
				rs.PageSize = 12
				...
				%>
						<div style="float:left; margin:10px; width:230px;">
						 <table width="150" border="0" cellpadding="0" cellspacing="0">
							  ...
							  <tr>
								<td align="center">
								<div style="width:220px; height:25px; overflow:hidden">
