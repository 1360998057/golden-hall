...
<frameset rows="80,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset rows="*" cols="165,*" framespacing="0" frameborder="no" border="0">
    <frame src="left.asp" name="leftmenu" id="mainFrame" title="mainFrame" />
    <frameset rows="50,*" cols="*" framespacing="0" frameborder="no" border="0">
    <frame src="menu.asp" name="topmenu" id="mainFrame" title="mainFrame" />
    <frame src="main.asp" name="main" scrolling="yes" noresize="noresize" id="rightFrame" title="rightFrame" />
  </frameset>
  </frameset>
