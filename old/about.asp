				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr valign="top">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="130" height="36" align="center"><div id="lbt"><% response.write(""&rs("title")&"") %></div></td>
								<td align="right" style="padding-right:10px;"><div id="lat">当前位置：<a href="Index.asp">首页</a> > <% response.write(""&rs("title")&"") %></div></td>
							</tr>
						</table>  
						</td>
					</tr>
